...
export default class TFIOSScreen extends Component {
  ...
  render() {
    ...
    return (
      ...
      <View>
        <Text style={styles.header}>THE HOBBIT</Text>
        <Text style={{textAlign: 'center', marginBottom: 10,}}>by J. R. R. Tolkien</Text>
      </View>

      <View>
        <Image source={{uri: 'https://www.fantasybookreview.co.uk/images/The-Hobbit.gif'}} 
...
I would suggest reading the illustrated version if you have the choice, the artwork by Alan Lee is so good that it manages to improve a story that is already fabulous.The Hobbit is quite simply a must read, a real delight.
        </Text>
        </View>
      </ScrollView>
    );
